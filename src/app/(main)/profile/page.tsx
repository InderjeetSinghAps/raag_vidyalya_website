    ...
    items: [
      {
        ...
        icon: BookOpen,
        action: 'link',
        value: '/courses/my-courses',
      },
      {
        label: 'Bookmarks',
        icon: Bookmark,
        action: 'link',
        value: '/courses/bookmarks',
      },
...
function SetPasswordModal({
  ...
  const [changePassword, { isLoading: saving }] =
    useChangePasswordMutation();
  ...
  const strengthBars =
    Math.floor(strength / 4) + (strength > 0 ? 1 : 0);
                  ...
                  {[0, 1, 2, 3].map((i) => (
                    <div
                      ...
                      className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                        i < strengthBars
                          ? strengthColors[strengthBars - 1] +
                            ' shadow-[0_0_6px_rgba(212,164,74,0.3)]'
                          : 'bg-muted'
                      }`}
                    />
                  ))}
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      >
        <div className="relative mb-5">
          <div
            className="pointer-events-none absolute -inset-3 rounded-full bg-[#D4A44A]/[0.08] blur-2xl"
            aria-hidden="true"
          />
      ...
      />
      <SetPasswordModal
        open={activeModal === 'setPassword'}
        onClose={closeModal}
      />
      <ChangeLanguageModal
        open={activeModal === 'changeLanguage'}
        onClose={closeModal}
      />
      <SuggestionModal
