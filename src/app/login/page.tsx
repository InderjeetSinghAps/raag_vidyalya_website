...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      ...
      <Button
        variant="outline"
        className="h-11 w-full rounded-xl border-white/[0.08] bg-white/[0.04] text-sm font-medium text-white/70 shadow-sm transition-all duration-200 hover:border-white/[0.15] hover:bg-white/[0.08] hover:text-white active:scale-[0.98]"
      >
