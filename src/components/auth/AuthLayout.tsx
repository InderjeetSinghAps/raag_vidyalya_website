...
export function AuthLayout({
  ...
  return (
    <div className="flex min-h-dvh w-full overflow-y-auto">
      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="absolute bottom-16 left-12 right-12 z-10">
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/50">
            Immerse yourself in the divine art of Gurmat Sangeet.
            Learn ancient raags, sacred hymns, and timeless melodies
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center overflow-y-auto px-4 sm:px-8 bg-gradient-to-br from-background via-secondary to-background dark:from-[#0B1220] dark:via-[#0F1A2E] dark:to-[#0B1730]">
        ...
        {rightPanelContent && (
          <div className="relative mb-8">{rightPanelContent}</div>
        )}
